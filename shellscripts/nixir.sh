...
# This script has been copied from https://github.com/diogo-fernan/ir-rescue/blob/master/nix/ir-rescue-nix-v1.1.0.sh
# You can find a better, more accurate and probably more effective version at the authors site https://github.com/diogo-fernan/ir-rescue
# This version has been created so I can have one to tweak as needed and experiment with various elements.
# If you are looking for better IR shell scripts go to https://github.com/diogo-fernan/ir-rescue!
